let Item;_f9e‍.w("./itemclass.js",[["default",["Item"],function(v){Item=v}]]);
...
_f9e‍.g.console.log(tv1.getMake());
_f9e‍.g.console.log(tv1.getModel());
console.log(`${tv1.priceWithTax()} extended from Item class`);
console.log(`${tv1.getQty()} extended from Item class`);
_f9e‍.g.console.log(tv1.getTax());
_f9e‍.g.console.log(tv1.getInvoice());
_f9e‍.g.console.log(tv1.display());
